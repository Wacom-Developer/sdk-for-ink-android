...
import com.wacom.ink.samples.erasingstrokes.model.Stroke;
import com.wacom.ink.samples.erasingstrokes.model.StrokeSerializer;
import com.wacom.ink.smooth.MultiChannelSmoothener;
import com.wacom.ink.smooth.MultiChannelSmoothener.SmoothingResult;

public class ErasingStrokesPart1 extends Activity {
		...
		surfaceView.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				if (bFinished){
					...
					Toast.makeText(ErasingStrokesPart1.this, "We have " + strokesList.size() + " strokes in the list.", Toast.LENGTH_SHORT).show();
				}
				return true;
			}
		});
